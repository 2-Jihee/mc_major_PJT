...
path = 'C:/Users/USER/driver/chromedriver.exe'
driver = webdriver.Chrome(path)
driver.implicitly_wait(3)
driver.get(
    'https://kosis.kr/statHtml/statHtml.do?orgId=101&tblId=DT_1B26001_A01&vw_cd=MT_ZTITLE&list_id=A_1&scrId=&seqNo=&lang_mode=ko&obj_var_id=&itm_id=&conn_path=MT_ZTITLE&path=%252FstatisticsList%252FstatisticsListIndex.do')
time.sleep(2)
...
expander_lst = driver.find_elements(By.CSS_SELECTOR, '#ft-id-2 > li > span > span.fancytree-expander')
chkBox_lst2 = driver.find_elements(By.CSS_SELECTOR, '#ft-id-4 > li > span > span.fancytree-checkbox')
...
for i in chkBox_lst1:
    ...
    if city_check == 0:
        ...
        # 최하위레벨 선택
        driver.find_element(By.XPATH, '''//*[@id="fancytree_1CheckOption"]''').click()
        time.sleep(0.5)
        driver.find_element(By.XPATH, '''//*[@id="fancytree_1CheckOption"]/option[3]''').click()
        time.sleep(0.5)
    ...
    # 전체 해제
    driver.find_element(By.XPATH, '''//*[@id="fancytree_1Btn"]''').click()
    time.sleep(0.5)
    ...
    # 전체 해제
    driver.find_element(By.XPATH, '''//*[@id="timePopListMBtn"]''').click()
    time.sleep(0.5)
